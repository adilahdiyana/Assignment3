...
public class AdminInfo extends JFrame {
	...
	public AdminInfo() {
		...
		panel_1_1.setBounds(374, 154, 365, 197);
		panel.add(panel_1_1);
		...
		lblBrandOfCloth.setBounds(12, 60, 157, 37);
		...
		btnReset.setBounds(190, 491, 137, 46);
		panel.add(btnReset);
		...
		btnConfirm.setBounds(109, 415, 137, 46);
		...
		btnConfirm.setFont(new Font("STZhongsong", Font.BOLD, 18));
		
		JButton btnExit = new JButton("Exit");
		btnExit.setBounds(417, 487, 99, 55);
		panel.add(btnExit);
