...
public class ClothDetail extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClothDetail frame = new ClothDetail();
	...
	public ClothDetail() {
		...
		JButton custRegistration = new JButton("Login to Rent Now!");
		...
		custRegistration.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Login par = new Login(getFashionModernFee(),getTraditionalCustomsFee(),getDinnerDressFee()); // calling another frame/window
