...
public class customerClothType extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					customerClothType frame = new customerClothType();
	...
	public customerClothType() {
		...
		lblSize.setFont(new Font("STXinwei", Font.BOLD, 30));
		lblSize.setBounds(12, 149, 207, 42);
		panel_3.add(lblSize);
		...
		comboBoxType.setModel(new DefaultComboBoxModel(new String[] {"Select the type", "Fashion Modern", "Traditional Customs", "Dinner Dress"}));
										...
										comboBoxBrand.addActionListener(new ActionListener() {
											public void actionPerformed(ActionEvent e) {
												...
												String size,price;
													for(int i=0; i<t.getRowCount(); i++) {
														if(comboBoxBrand.getSelectedItem().equals(t.getValueAt(i, 1))) {
															size = String.valueOf(t.getValueAt(i, 2));
															size = String.valueOf(t.getValueAt(i, 3));
															textFieldSize.setText(size);
															textFieldprice.setText(size);
														}
													}
											}
										});
		...
		textFieldSize.setFont(new Font("Tahoma", Font.PLAIN, 30));
		textFieldSize.setBounds(280, 151, 279, 40);
		panel_3.add(textFieldSize);
