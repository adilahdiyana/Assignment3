...
public class Login extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				try { // 2.2 Exception Handling
					if (UserNameTextField.getText().equals("adilah") && PasswordTextField.getText().equals("ad")
						...
						AdminCompany a = new AdminCompany(); // calling another frame/window
					...
					for (int i = 0; i < UserRegistration.table.getRowCount(); i++) {
						...
						if (UserNameTextField.getText().equals(UserRegistration.table.getValueAt(i, 0))
							...
							JOptionPane.showMessageDialog(null, "Login Succesful!");
							CustomerRegistration gm = new CustomerRegistration(); // calling another frame/window
	...
	public Login(String fmf, String tcf, String ddf) {
		this.fmf = fmf;
		this.tcf = tcf;
		this.ddf= ddf;
			...
			public void actionPerformed(ActionEvent e) {
				try {// 2.2 Exception Handling
					...
					if (UserNameTextField.getText().equals("alex") && PasswordTextField.getText().equals("12345")
							&& UserComboBox.getSelectedItem().equals("Customer")) {
						JOptionPane.showMessageDialog(null, "Login Succesful!");
						CustomerRegistration gm = new CustomerRegistration(getFashionModernFee(), getTraditionalCustomsFee(),
